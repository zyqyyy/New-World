...
<head>
	...
	function myCheck() {
		...
		if (Check()) {
			formSubmit('${ctx}/cargo/contractproduct/addExtProductCreate', '_self');
		}
...
<li id="back"><a href="${ctx}/cargo/contractproduct/toProductCreate?contractId=${contractId}">返回</a></li>
</ul>
    </div>
</div>
</div>
...
<div>
	...
	<table id="ec_table" class="tableRegion" width="98%" >
		...
		<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
			...
			<td>${o.AMOUNT}</td>
			<td>
				<a href="${ctx}/cargo/contractproduct/toExtProductupdate?extCproductId=${o.EXT_CPRODUCT_ID}">[修改]</a>
				<a href="${ctx}/cargo/contractproduct/ExtProductdelete?extCproductId=${o.EXT_CPRODUCT_ID}&contractProductId=${ContractProductId}"   onclick="return del()">[删除]</a>
			</td>
		</tr>
		</c:forEach>
