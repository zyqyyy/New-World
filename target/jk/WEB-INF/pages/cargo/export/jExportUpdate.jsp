...
<body>
<form method="post">
	<input type="hidden" name="exportId" value="${obj.EXPORT_ID}">
...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/export/exportUpdate','_self');">确定</a></li>
		...
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContentAuto">
	            	<input type="radio" name="LCNO" value="T/T" class="input" <c:if test="${obj.LCNO=='T/T'}">checked</c:if> checked="checked">T/T
	        ...
	        <tr>
	            ...
	            <td class="columnTitle_mustbe">运输方式：</td>
		            <td class="tableContentAuto">
	            	<input type="radio" name="TRANSPORT_MODE" value="SEA" class="input" <c:if test="${obj.TRANSPORT_MODE=='SEA'}">checked</c:if> checked="checked">海运(SEA)
