...
<body>
<form method="post">
	<input type="hidden" name="id" value="${obj.EXT_CPRODUCT_ID}"> 
	<input type="hidden" name="contractProductId" value="${obj.CONTRACT_PRODUCT_ID}"> 
...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/cargo/contractproduct/ExtProductupdate.action','_self');">确定</a></li>
<li id="back"><a href="${ctx}/cargo/contractproduct/toExtProductCreate?contractProductId=${obj.CONTRACT_PRODUCT_ID}">返回</a></li>
</ul>
    </div>
</div>
</div>
